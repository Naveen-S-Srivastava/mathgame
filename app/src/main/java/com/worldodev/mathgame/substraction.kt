...
class substraction : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        buttonnext.setOnClickListener {
            ...
            if(userlife == 0){
                ...
                val intent = Intent(this@substraction,ResultActivity::class.java)
    ...
    fun gameContinue(){
        ...
        if (number1 > number2) {
            ...
            resertimer()
            // Re-run the gameContinue function if the condition is not met
            gameContinue()
